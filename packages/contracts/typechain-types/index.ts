...
export type { TrainingCertification } from "./contracts/TrainingCertification";
export { TrainingCertification__factory } from "./factories/contracts/TrainingCertification__factory";
