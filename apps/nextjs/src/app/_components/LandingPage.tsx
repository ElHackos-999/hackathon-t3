        ...
        <main className="flex flex-1 flex-col items-center justify-center gap-8 p-4 text-center">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground mx-auto max-w-2xl text-lg sm:text-xl">
              Verified course completions. Earn digital certificates, generate
              shareable proofs, and let employers verify your credentials
              instantly.
            </p>
          </div>
          ...
          <div className="grid max-w-4xl grid-cols-1 gap-6 sm:grid-cols-3">
            <div className="rounded-lg border p-4">
              ...
              <p className="text-muted-foreground mt-1 text-sm">
                Receive verifiable credentials as proof of course completion
              </p>
            </div>
            <div className="rounded-lg border p-4">
